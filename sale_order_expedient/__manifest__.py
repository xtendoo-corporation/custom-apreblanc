{
    ...
    'data': [
        # Asegúrese de que todos los archivos XML listados aquí existan y estén bien formados
        ...
        'data/ir_cron.xml',  # Añadido archivo de tareas programadas
        ...
        'views/sale_order_views.xml',  # Eliminada la duplicación
