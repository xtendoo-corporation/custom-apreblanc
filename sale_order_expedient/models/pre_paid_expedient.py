...
class PrePaidExpedient(models.Model):
    ...
    def create(self, vals):
        if vals.get('name', _('New Pre-paid Expedient')) == _('New Pre-paid Expedient'):
            vals['name'] = self.env['ir.sequence'].next_by_code('pre.paid.expedient') or _('New Pre-paid Expedient')
