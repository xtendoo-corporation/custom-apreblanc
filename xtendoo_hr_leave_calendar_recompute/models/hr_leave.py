...
class HrLeave(models.Model):
    ...
    @api.model
    def xtd_get_default_calculation_calendar(self, employee=False):
    ...
    def create(self, vals_list):
        ...
        for values in vals_list:
            ...
            calendar = self.xtd_get_default_calculation_calendar(employee)
            if calendar:
    ...
    def _onchange_xtd_calculation_calendar_id(self):
        for leave in self:
            ...
            previous_calendar = (
                ...
                or leave.xtd_get_default_calculation_calendar(previous_employee)
            )
            new_calendar = leave.xtd_get_default_calculation_calendar(leave.employee_id)
            if (
    ...
    def xtd_action_recompute_duration_with_calendar(
        ...
        for leave in self:
            ...
            if xtd_calendar_mode == "manual":
                ...
                target_calendar = leave.xtd_get_default_calculation_calendar(
                    leave.employee_id
                )
            else:
                target_calendar = (
                    leave.xtd_calculation_calendar_id
                    or leave.xtd_get_default_calculation_calendar(leave.employee_id)
                )
